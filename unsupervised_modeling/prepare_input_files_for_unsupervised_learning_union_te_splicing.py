...
def print_outlier_output_file_no_nan(outlier_dicti1, outlier_dicti2, genomic_annotation_file, output_file, gene_individual_to_variant_mapping_file):
	t = open(output_file, 'w')
	f = open(genomic_annotation_file)
	head_count = 0
	for line in f:
		...
		gene_id = data[1].split('.')[0]
		sample_name = indi_id + '_' + gene_id
		if sample_name in outlier_dicti1 and sample_name in outlier_dicti2:
			if np.isnan(outlier_dicti1[sample_name]) == False and np.isnan(outlier_dicti2[sample_name]) == False:
...
outlier_genes = union_of_three_dictionaries(splicing_outlier_genes, total_expression_outlier_genes)
...
# Print outliers
splicing_output_file = unsupervised_learning_input_dir + 'splicing_outliers_' + str(pvalue) + '_genes_union_between_te_splicing.txt'
...
# Print outliers
total_expression_output_file = unsupervised_learning_input_dir + 'total_expression_outliers_' + str(pvalue) + '_genes_union_between_te_splicing.txt'
...
# Print outliers
splicing_output_file = unsupervised_learning_input_dir + 'fully_observed_splicing_outliers_' + str(pvalue) + '_genes_union_between_te_splicing.txt'
print_outlier_output_file_no_nan(splicing_outliers, total_expression_outliers, genomic_annotation_file, splicing_output_file, gene_individual_to_variant_mapping_file)
# Print outliers
total_expression_output_file = unsupervised_learning_input_dir + 'fully_observed_total_expression_outliers_' + str(pvalue) + '_genes_union_between_te_splicing.txt'
