...
full_new_file = score_dir + 'fully_observed_te_ase_splicing_outliers_gene_pvalue_0.01_outlier_fraction_.01_pseudocount_30_exact_inference_apply_to_all_variants_gene_level_posteriors.txt'
full_old_file = score_dir + 'old_fully_observed_te_ase_splicing_outliers_gene_pvalue_0.01_outlier_fraction_.01_pseudocount_30_exact_inference_apply_to_all_variants_gene_level_posteriors.txt'

shortened_new_file = score_dir + 'fully_observed_te_ase_splicing_outliers_gene_pvalue_0.01_outlier_fraction_.01_pseudocount_30_exact_inference_apply_to_all_variants_gene_level_posteriors_short.txt'
shortened_old_file = score_dir + 'old_fully_observed_te_ase_splicing_outliers_gene_pvalue_0.01_outlier_fraction_.01_pseudocount_30_exact_inference_apply_to_all_variants_gene_level_posteriors_short.txt'

output_file = score_dir + 'gene_level_comparison.txt'
