...
merged_no_tissue_anno_diff_n2_pairs_output_file = unsupervised_learning_input_dir + 'fully_observed_merged_outliers_' + str(pvalue) + '_genes_intersection_between_te_ase_splicing_features_filter_no_tissue_anno_diff_N2_pairs_as_standard_450000_' + str(seeder) + '.txt'
...
# Randomly subset the previous file (merged_no_tissue_anno_output_file) to N training instances
merged_no_tissue_anno_same_n2_pairs_output_file = unsupervised_learning_input_dir + 'fully_observed_merged_outliers_' + str(pvalue) + '_genes_intersection_between_te_ase_splicing_features_filter_no_tissue_anno_same_N2_pairs_as_standard_450000_' + str(seeder) + '.txt'
# Make sure it has the same features as standard watershed file
standard_watershed_file = unsupervised_learning_input_dir + 'fully_observed_merged_outliers_0.01_genes_intersection_between_te_ase_splicing_features_filter_no_tissue_anno_N2_pairs_' + str(seeder) + '.txt'
