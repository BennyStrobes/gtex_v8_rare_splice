...
Rscript watershed_score.R $pvalue_fraction $number_of_dimensions $inference_method $pseudocount $fully_observed_input_file $all_variants_input_file $output_stem