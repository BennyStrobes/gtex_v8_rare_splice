...
gene_thresh="0.01"
input_stem="total_expression_impute_tbt_outliers_"$gene_thresh"_genes_intersection_between_te_ase_splicing"
...
Rscript watershed_roc_tbt.R $pvalue_fraction $input_file $output_stem $number_of_dimensions $pseudocount $gradient_descent_threshold $theta_pair_init $lambda_pair
