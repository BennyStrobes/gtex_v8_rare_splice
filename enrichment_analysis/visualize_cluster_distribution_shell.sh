...
cluster_assignment_file="Muscle_Skeletal_cluster_assignments.txt"
Rscript visualize_cluster_distribution.R $clusters_to_plot_file $tissue_name $exon_file $cluster_assignment_file
